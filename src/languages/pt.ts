...
export const portugueseJson: ILanguageJSON = {
    homePage: {
        footer:['Obrigado por ver meu perfil.', 'Acompanhe meus repositórios e histórias.'],
        header: ["Olá Geek",
            "Seja bem vindo🚀"],
        bio: ['Desenvolvedor Pleno I', 'Programo desde 2019, onde iniciei minhas aulas de lógica no Ifes. Sou uma pessoa bem comunicativa e tenho facilidade para trabalhar no contato ao cliente levantando requisitos, sem dificuldades para trabalhar em time. Trabalho atualmente de desenvolvedor Full Stack, com foco em Front-End na Empresa AdGrowth. ', 'Durante esse período atuei em diversos projetos com uma atenção a mais em React Js, TypeScript e NodeJS, atualmente estou integralmente em um projeto mobile, trabalhando com React Native, oque tem sido o meu foco nos últimos meses.']
    },
    stacks: {
        stacksDescription: [
            {
                ...
                myXP: "Trabalhei com esta biblioteca ao longo de toda minha carreira de desenvolvedor,trabalhando em vários projetos de escopos diferentes."
            },
            {
                image:reactnative,
                title: 'React Native',
            ...
            },
            {
                ...
                myXP: "Uma excelente tecnologia para usar em projetos com grande número de renderizações."
            },
            {
                image:nodejs,
                title: 'NodeJS',
                description: 'Node.js é um software de código aberto, multiplataforma, baseado no interpretador V8 do Google e que permite a execução de códigos JavaScript fora de um navegador web. A principal característica do Node.js é sua arquitetura assíncrona e orientada a eventos.',
                myXP: "Uma das principais tecnologias usadas para criação de APIs Rest, na qual trabalhei principalmente com o auxílio do ExpressJS"
            },
            {
                image:angular,
                title: 'AngularJS',
                description: 'AngularJS é um framework JavaScript código aberto, mantido pelo Google, que auxilia na execução de single-page applications.',
                myXP: "Excelente tecnologia para criação de aplicações web, com uso de uma arquitetura baseada em módulos."
            },
            {
                image:typescript,
                title: 'TypeScript',
                ...
                myXP: "Tecnologia super importante quando utilizada para implementar os princípios de orientação a objetos em seu código Javascript."
            },
            {
                image:adonisjs,
                title: 'Adonis JS',
                description: 'O AdonisJS é um framerwork Node. js que surgiu para trazer facilidades ao desenvolvedor incluindo padrões de estruturação do projeto.',
                myXP: 'Por causa disso, o Adonis é conhecido por ser um framework opinado, isto é, ele segue um padrão de desenvolvimento e "força" o desenvolvedor a segui-lo.'
            },
            {
                image:express,
                title: 'ExpressJS',
                description: 'Express.js é um framework para Node.js que fornece recursos mínimos para construção de servidores web. Foi lançado como software livre e de código aberto sob a Licença MIT. ',
                myXP: "É um dos mais populares frameworks para servidores em Node.js"
            },
            {
                image:nestjs,
                title: 'NestJS',
                description: 'NestJS é um framework Node.js de código aberto destinado ao desenvolvimento de aplicativos do lado do servidor. Foi criado por Kamil Mysliwiec e lançado em 2017. Sob o capô, por padrão, o NestJS faz uso do framework Express.js, sendo também compatível com o Fastify.',

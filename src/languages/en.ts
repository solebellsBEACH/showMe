      ...
      context: [
        {
          ...
          text: "I've always worked with current technologies, getting 100% involved with the project and the end result. ",
        },
        {
          header: 'Experience and Knowledge',
          text: "Throughout my history, I've worked with different segments and developed the necessary know- how to work on the most diverse projects.",
        },
        {

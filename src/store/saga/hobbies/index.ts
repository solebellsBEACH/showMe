...
import { Types as HobbiesTypes, Creators as HobbiesActions } from '../../ducks/hobbies';
...
function* getHobbiesPageDataWatcher() {
    yield takeLatest(HobbiesTypes.GET_HOBBIESPAGE_DATA_REQUEST, getHobbiesPageData);
}
